...
if not hasattr(time, 'ticks_ms'):
    time.ticks_ms = lambda : time.process_time() * 1000.
# else:
...
class SlimDNSServer:
    ...
    def handle_question(self, q, answer_callback, fast=False, retry_count=3):
        ...
        pack_into("!HHHHHH", p, 0,
                  1, 0, 1, 0, 0, 0)  ##Threw error, removed last 0. See: https://github.com/nickovs/slimDNS/issues/4#issuecomment-440101488
        p[12:] = q
